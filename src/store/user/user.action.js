...
export const signUpSuccess = (user, additionalDetail ) => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, additionalDetail });
...
export const signOutFailed = (error) => createAction(USER_ACTION_TYPES.SIGN_UP_FAILED, error);
